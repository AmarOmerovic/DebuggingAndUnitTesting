...
public class Utilities {
    ...
    // Returning a char array containing every nth char. When sourceArray.length < n, returns sourceArray
    ...
    // Remove pairs of the same character that are next to each other , by removing on occurred of the character.
    // "ABBCDEEF" -> "ABCDEF"
